...
exports.default = function (src) {
  ...
  return new Promise(function (resolve) {
    if (_fs2.default.existsSync(process.env.PWD + '/truffle.js')) {
      var config = _truffleConfig2.default.detect({ working_directory: process.env.PWD });
      ...
      _truffleCompile2.default.all(config, function (err, res) {
        ...
        resolve({
          contracts: Object.keys(res).reduce(function (o, k) {
            var _res$k = res[k],
                metadata = _res$k.metadata,
                data = _objectWithoutProperties(_res$k, ['metadata']);
      ...
      var exec = 'solc --combined-json abi,asm,ast,bin,bin-runtime,clone-bin,devdoc,interface,opcodes,srcmap,srcmap-runtime,userdoc,metadata ' + src;
